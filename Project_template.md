...
**Вывод: буду выбирать из облачных моделей, например, Yandex GPT.**
...
Скрипт:   
[RAG-пайплайн](app/ragbot_cli2.py)
...
Добавил в системный промпт `..., who thinks first and then answers. Always write down your steps...`:
```
    system_message = (
        "You are a helpful assistant, who thinks first and then answers. Always write down your steps. Use the following context in your response:"
        f"\n\n{docs_content}"
    )
```
